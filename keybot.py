...
kr = LINETCR.LINE()
kr.login(token='Eq5QsNM4o2vsyxniQk43.L77yy5TwrBXy+Qwt0aYjyW.Mo5TsSCcZ8+SOe55/aBbvckYfvETMkd8EMwkKaiTzTA=')
kr.loginResult()
...
Bots=[mid]
owner=["u4a361586c55ac4ef218a0a9b78b2f1b3","u97bed8639b5645bc58fea593d00c8963",mid]
admin=["u4a361586c55ac4ef218a0a9b78b2f1b3","u97bed8639b5645bc58fea593d00c8963",mid]
baby=["u4a361586c55ac4ef218a0a9b78b2f1b3","u97bed8639b5645bc58fea593d00c8963"]
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
              ...
              if msg.from_ in admin:
                    ...
                    b = urllib.quote(a)
                    kr.sendText(msg.to,"「 Searching 」\n" "Type: GitHub Search\nStatus: Processing...")
                    kr.sendText(msg.to, "Title: " + a + "\nhttps://github.com/search?utf8=✓&q="+b)
                    kr.sendText(msg.to,"「 Searching 」\n" "Type: GitHub Search\nStatus: Success")
...
#========================== FOR COMMAND BOT STARTING =============================#
              ...
              if msg.from_ in admin:
                kr.sendText(msg.to,cl.authToken)
                        ...
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
                                        kr.sendText(op.param1, "Hai Jangan Ngintip Aja Chat napa @" +nick[0])
                                        #random.choice(KAC).kickoutFromGroup(op.param1, [op.param2])
                                    else:
                                        kr.sendText(op.param1, "Hai Jangan Ngintip Aja Chat napa @" +nick[1])
                                        #random.choice(KAC).kickoutFromGroup(op.param1, [op.param2])
                                else:
                                    kr.sendText(op.param1, "Hai Jangan Ngintip Aja Chat napa @" +Name)
                                    #random.choice(KAC).kickoutFromGroup(op.param1, [op.param2])
                        else:
                            pass
                    else:
